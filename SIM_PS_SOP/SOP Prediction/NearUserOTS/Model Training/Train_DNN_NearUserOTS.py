...
data = pd.read_csv('DataSet_NearUserOTS_1e4.csv')
data.shape
data.head()
...
model.add(keras.layers.Dense(256, activation='relu', input_shape = (12,), kernel_initializer='normal'))
...
# 
Epoch = 50 # The number of round for training.
BATCH_SIZE = 20 # 
#
...
print(model.summary())
# model.save('Trained_DNN_NearUserOTS.h5')

# verify the trained model
# new_model = keras.models.load_model('Trained_DNN_NearUserOTS.h5')
