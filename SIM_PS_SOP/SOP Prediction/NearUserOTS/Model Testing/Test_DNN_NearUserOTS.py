...
new_model = keras.models.load_model('Trained_DNN_NearUserOTS.h5') # call the fitted ML model for regression
...
for ii in range(len(PS_dB)):
    ...
    print('Predict Secrecy Outage Probability is ', y_pred, 'when PS_dB is', PS_dB[ii] )
